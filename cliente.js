...
axios.post(url+"/noticia", {
    titulo: 'Risco de contrair Covid-19 com máscara PFF2 é mínimo, aponta estudo',
...
axios.post(url+"/noticia", {
    titulo: 'Auxílio Brasil: com revisões cadastrais contínuas, famílias poderão ter benefício suspenso ou cancelado',
...
axios.post(url+"/noticia", {
    titulo: 'Réveillon 2022: cidades descartam festas, eventos ou shows',
...
axios.post(url+"/noticia", {
  titulo: 'Criminosos vendem dados pessoais pela internet utilizando cadastros de órgãos oficiais',
...
axios.post(url+"/noticia", {
    titulo: 'Sem recursos para construção, mulher cria hotel de barracas na zona rural de Areia, PB, durante a pandemia',
